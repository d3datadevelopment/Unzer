...
Welche Zahlungen können Sie Ihren Kunden nun anbieten? Möglich sind Bankeinzug / Lastschrift (wie SEPA), die bekanntesten Kredit-/Debitkarten (z.B. VISA, Mastercard, Amex), Direktüberweisung (z.B. Sofort, Unzer Direktüberweisung), wichtige Wallets (z.B. PayPal) und weitere Unzer-eigene Zahlungsarten (wie Prepayment - automatische Vorkasse, Invoice  - Rechnungskauf ohne Zahlungssicherung, etc.). Details finden Sie in unserer Übersicht: [Editionsunterschiede](015_Editionsunterschiede.md).
