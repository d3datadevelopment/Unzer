...
## [Unreleased](https://git.d3data.de/D3Private/Unzer/compare/7.2.2.0...rel_7.x)

## [7.2.2.0](https://git.d3data.de/D3Private/Unzer/compare/7.2.1.0...7.2.2.0) - 2026-04-02
### Added
- installierbar in OXID 7.4
...
## [7.1.0.1](https://git.d3data.de/D3Private/Unzer/compare/7.1.0.0...7.1.0.1) - 2024-10-22
### Removed
- incompatible (non PSR-3) d3log logger

## [7.1.0.0](https://git.d3data.de/D3Private/Unzer/compare/7.0.1.1...7.1.0.0) - 2024-06-26
### Added
