...
$aQueries = [
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_vorkassemail_cust_tex_twig' %s ;", $ShopIdQuery),
        'do'    => utf8_decode(
            'INSERT IGNORE INTO `oxcontents` (`OXID`, `OXLOADID`, `OXSHOPID`, `OXSNIPPET`, `OXTYPE`, `OXACTIVE`, `OXACTIVE_1`, `OXPOSITION`, `OXTITLE`, `OXCONTENT`, `OXTITLE_1`, `OXCONTENT_1`, `OXACTIVE_2`, `OXTITLE_2`, `OXCONTENT_2`, `OXACTIVE_3`, `OXTITLE_3`, `OXCONTENT_3`, `OXCATID`, `OXFOLDER`, `OXTERMVERSION`) VALUES(md5("d3_hp_vorkassemail_cust_tex_twig_' . $sShopid . '"), "d3_hp_vorkassemail_cust_tex_twig", "' . $sShopid . '", 1, 0, 1, 1, "", "Unzer Vorkasseinfomail Kunde Text", "Sehr geehrter Kunde,<br/><br/>' . PHP_EOL . PHP_EOL . '<p>Sie haben bei Ihrer Bestellung die Bezahlart \"Vorkasse\" oder \"Rechnung\" gewählt. ' . PHP_EOL . 'Wir konnten heute Ihren Zahlungseingang verbuchen.<br/><br/>' . PHP_EOL . '{% if order.blDifferentAmount %}Achtung, der von Ihnen überwiesene Betrag ({{order.fPayAmount}} {{order.oxorder__oxcurrency.value}}) stimmt nicht mit dem Gesamtbetrag der Bestellung ({{order.getTotalOrderSum()}} {{order.oxorder__oxcurrency.value}}) überein!<br/><br/>' . PHP_EOL . 'Bitte kontaktieren Sie uns umgehend per eMail oder Telefon.' . PHP_EOL . '{% else %}' . PHP_EOL . 'Ihre Bestellung wird nun umgehend von uns bearbeitet und versandt.' . PHP_EOL . '{% endif %}' . PHP_EOL . '</p><br/><br/>' . PHP_EOL . PHP_EOL . 'Vielen Dank.<br/><br/>' . PHP_EOL . PHP_EOL . 'Beste Grüße<br/>' . PHP_EOL . 'Ihr Shop Team", "", "", 1, "", "", 1, "", "", "8a142c3e4143562a5.46426637", "CMSFOLDER_EMAILS", "");'
        ),
    ],
    [
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_vorkassemail_cust_sub_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_vorkassemail_cust_pl_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_vorkassemail_owner_te_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
            'INSERT IGNORE INTO `oxcontents` (`OXID`, `OXLOADID`, `OXSHOPID`, `OXSNIPPET`, `OXTYPE`, `OXACTIVE`, `OXACTIVE_1`, `OXPOSITION`, `OXTITLE`, `OXCONTENT`, `OXTITLE_1`, `OXCONTENT_1`, `OXACTIVE_2`, `OXTITLE_2`, `OXCONTENT_2`, `OXACTIVE_3`, `OXTITLE_3`, `OXCONTENT_3`, `OXCATID`, `OXFOLDER`, `OXTERMVERSION`) VALUES(md5("d3_hp_vorkassemail_owner_te_twig_' . $sShopid . '"), "d3_hp_vorkassemail_owner_te_twig", "' . $sShopid . '", 1, 0, 1, 1, "", "Unzer Vorkasseinfomail Shopinhaber Text", "Hallo,<br/><br/>' . PHP_EOL . PHP_EOL . 'Soeben konnte für Bestellung Nr. {{order.oxorder__oxordernr.value}} ein Zahlungseingang verbucht werden.<br/><br/>' . PHP_EOL . PHP_EOL . '{% if order.blDifferentAmount %}' . PHP_EOL . '<div style=\"color: red; font-weight: bold;\">' . PHP_EOL . 'Achtung, der überwiesene Betrag ({{order.fPayAmount}} {{order.oxorder__oxcurrency.value}}) stimmt NICHT mit dem Gesamtbetrag der Bestellung ({{order.getTotalOrderSum()}} {{order.oxorder__oxcurrency.value}}) überein!' . PHP_EOL . '</div><br/>' . PHP_EOL . '{% else %}' . PHP_EOL . '<div style=\"color: #123123; font-weight: bold;\">' . PHP_EOL . 'Der überwiesene Betrag ({{order.getTotalOrderSum()}} {{order.oxorder__oxcurrency.value}}) stimmt mit der Bestellsumme überein. Die Bestellung kann versandt werden.' . PHP_EOL . '</div><br/>' . PHP_EOL . '{% endif %}", "", "", 1, "", "", 1, "", "", "46e600fc114cfaa0788622a07c6c3fec", "CMSFOLDER_EMAILS", "");'
        ),
    ],
    [
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_vorkassemail_owner_su_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_vorkassemail_owner_pl_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_partlypaid_owner_text_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
            'INSERT IGNORE INTO `oxcontents` (`OXID`, `OXLOADID`, `OXSHOPID`, `OXSNIPPET`, `OXTYPE`, `OXACTIVE`, `OXACTIVE_1`, `OXPOSITION`, `OXTITLE`, `OXCONTENT`, `OXTITLE_1`, `OXCONTENT_1`, `OXACTIVE_2`, `OXTITLE_2`, `OXCONTENT_2`, `OXACTIVE_3`, `OXTITLE_3`, `OXCONTENT_3`, `OXCATID`, `OXFOLDER`, `OXTERMVERSION`) VALUES(md5("d3_hp_partlypaid_owner_text_twig' . $sShopid . '"), "d3_hp_partlypaid_owner_text_twig", "' . $sShopid . '", 1, 0, 1, 1, "", "Unzer Teilzahlungsinfomail Shopinhaber Text", "Hallo,<br/><br/>' . PHP_EOL . PHP_EOL . 'Soeben konnte für Bestellung Nr. {{order.oxorder__oxordernr.value}} ein teilweiser Zahlungseingang verbucht werden.<br/><br/>' . PHP_EOL . PHP_EOL . '<div style=\"color: red; font-weight: bold;\">' . PHP_EOL . 'Achtung, der überwiesene Betrag ({{order.fPayAmount}}) stimmt NICHT mit dem Gesamtbetrag der Bestellung ({{order.getTotalOrderSum()}} {{order.oxorder__oxcurrency.value}}) überein!' . PHP_EOL . '</div><br/>' . PHP_EOL . '" , "", "", 1, "", "", 1, "", "", "46e600fc114cfaa0788622a07c6c3fec", "CMSFOLDER_EMAILS", "");'
        ),
    ],
    [
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_partlypaid_owner_subj_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_partlypaid_owner_pl_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_chargeback_owner_text_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_chargeback_owner_subj_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
    ...
    [
        'check' => sprintf("SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_chargeback_owner_pl_twig' %s;", $ShopIdQuery),
        'do'    => utf8_decode(
