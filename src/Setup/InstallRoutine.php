...
class InstallRoutine extends d3install_updatebase
{
    ...
    public $sModRevision = '6510';

    /**
     * @var string
     */
    public $sBaseConf = '--------------------------------------------------------------------------------
h6xv2==
--------------------------------------------------------------------------------';
