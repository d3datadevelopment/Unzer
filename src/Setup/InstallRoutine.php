...
class InstallRoutine extends d3install_updatebase
{
    ...
    public $sModRevision = '6221';

    /**
     * @var string
     */
    public $sBaseConf = '--------------------------------------------------------------------------------
97Yv2==
--------------------------------------------------------------------------------';
