...
class InstallRoutine extends d3install_updatebase
{
    ...
    public $sModRevision = '6203';

    /**
     * @var string
     */
    public $sBaseConf = '--------------------------------------------------------------------------------
hAfv2==
--------------------------------------------------------------------------------';
