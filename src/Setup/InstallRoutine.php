...
class InstallRoutine extends d3install_updatebase
{
    ...
    public $sModRevision = '6202';

    /**
     * @var string
     */
    public $sBaseConf = '--------------------------------------------------------------------------------
YZFv2==
--------------------------------------------------------------------------------';
