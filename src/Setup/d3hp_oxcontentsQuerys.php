...
$aQueries = [
    ...
    [
        'check' => "SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_partlypaid_owner_text' $ShopIdQuery;",
        'do'    => utf8_decode(
    ...
    [
        'check' => "SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_partlypaid_owner_subject' $ShopIdQuery;",
        'do'    => utf8_decode(
    ...
    [
        'check' => "SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_partlypaid_owner_plain' $ShopIdQuery;",
        'do'    => utf8_decode(
    ...
    [
        'check' => "SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_chargeback_owner_text' $ShopIdQuery;",
        'do'    => utf8_decode(
    ...
    [
        'check' => "SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_chargeback_owner_subject' $ShopIdQuery;",
        'do'    => utf8_decode(
    ...
    [
        'check' => "SELECT if(count(`OXID`), 0, 1) FROM `oxcontents` WHERE `oxloadid` = 'd3_hp_chargeback_owner_plain' $ShopIdQuery;",
        'do'    => utf8_decode(
