...
$aQueries = [
    ...
    [
        'check' => "SELECT if(count(OXID), 0, 1) FROM oxpayments WHERE oxid = 'd3directbanktransfer';",
        'do'    => "INSERT IGNORE INTO `oxpayments` (`OXID`, `OXACTIVE`, `OXDESC`, `OXADDSUM`, `OXADDSUMTYPE`, `OXFROMBONI`, `OXFROMAMOUNT`, `OXTOAMOUNT`, `OXVALDESC`, `OXCHECKED`, `OXDESC_1`, `OXVALDESC_1`, `OXDESC_2`, `OXVALDESC_2`, `OXDESC_3`, `OXVALDESC_3`, `OXLONGDESC`, `OXLONGDESC_1`, `OXLONGDESC_2`, `OXLONGDESC_3`, `OXSORT`) VALUES('d3directbanktransfer', 0, 'Direktüberweisung', 0, 'abs', 0, 0, 999999999, '', 0, '', '', '', '', '', '', '', '', '', '', 0);",
    ],
    [
