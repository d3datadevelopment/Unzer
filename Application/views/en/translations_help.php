...
return [
    ...
    'HELP_D3UNZER_sD3HpHFOrderPendingTime'              => 'Stellen Sie hier die Zeit in Stunden ein, ' //
    ...
    'HELP_D3UNZER_sD3HpHFOrderCancelType'               => 'W&auml;hlen Sie die Art, wie die PENDING-Bestellungen abgearbeitet werden.<br>Im Standard wird die Bestellung auf NOT_FINISHED (oxtransstatus) gestellt.',
    'HELP_D3UNZER_sD3HpHFOrderLimit'                    => 'Bei vielen Bestellungen kann es zu Ressourcenlimits des Servers kommen.<br>' //
    ...
    'HELP_D3UNZER_blD3HpHFSetZeroOrderNumber'           => 'Ist diese Option inaktiv, werden Shop-Bestellungen mit fortlaufenden Bestellnummer generiert.',
    ...
    'HELP_D3DYN_HEIDELPAY_TESTMOD_ACTIVE'                   => 'Bei aktivem Testmodus wird mit dem Unzer-Testserver statt des Liveservers verbunden. <br><br>' //
...
z.B. "Kartenummer nicht korrekt".<br><br><b>Hinweis: Sicherheitsrelevante Meldungen wie "Karte gestohlen" werden nicht gezeigt!</b>',
    ...
    'HELP_D3UNZER_DIFFERENCE_IN_ORDER_ERRRORMAIL'       => 'Geben Sie hier eine E-Mail Adresse an, ' //
    ...
    'HELP_D3UNZER_DIFFERENCE_IN_ORDER_ERRRORSTATUS'     => 'Geben Sie hier den Transaktionsstatus ' //
    ...
    'HELP_D3UNZER_CARDTYPE_TIMEOUT'                     => 'Geben Sie hier das Dauer in Sekunden an, '
    ...
    'HELP_D3UNZER_SETTINGS_NOTIFYURL' => 'Das NGW System von Unzer bietet die Push Benachrichtigungen an. <br>
<br>
...
https://www.meine-shop-dom.ain/out/modules/d3unzer/notify.php<br>',
    'HELP_D3UNZER_CONFIG_TITLE'       => 'Der Titel der Konfiguration wird nur für interne Zwecke genutzt.',
    'HELP_D3UNZER_CONFIG_CHANNEL'     => 'Tragen Sie hier den von Unzer erhaltenen Channel ein.',
    'HELP_D3UNZER_CONFIG_PAYMENTTYPE' => 'Wählen Sie hier die zugehörige Unzer Zahlungsart aus, die zu dem eingetragenen Channel passt.',
    'HELP_D3UNZER_CONFIG_ISTESTCONFIG' => 'Wenn diese Option aktiv ist, wird die Kommunikation an das Unzer Testsystem, anstatt an das Livesystem übertragen.<br>
Es werden auf dem Test Server keine realen Buchungen durchgeführt!<br><br>' //
    ...
    'HELP_D3UNZER_INTERFACE_TYPE'                                   => 'Sollten Sie von Unzer SenderId, Login, Passwort und Channel Daten vorliegen haben, dann verwenden Sie die Auswahl "ngw".<br>'//
        .'Haben Sie ein Keypair erhalten nutzen Sie mgw/rest.',
    'HELP_D3UNZER_LOGIN_MGW_HEADER'                                 => 'Tragen Sie die von Unzer erhaltenen Zugangskeys ein. <br><br>'//
    ...
    'HELP_D3UNZER_MGW_AMOUNT_TOTAL' => 'Stellt den maximalen Betrag für diesen Auftrag dar. Dies ist in der Regel der autorisierte oder belastete Betrag. Dieser Betrag kann nur verringert werden, wenn die Stornierung aufgrund einer Autorisierung durchgeführt wurde.',
    'HELP_D3UNZER_MGW_AMOUNT_CHARGED' => 'Stellt den Betrag dar, der vom Kunden an den Händler überwiesen wurde.',
    'HELP_D3UNZER_MGW_AMOUNT_REMAINING' => 'Stellt die Differenz zwischen den gesamten und gebuchten Beträgen dar.',
    'HELP_D3UNZER_MGW_AMOUNT_CANCELED' => 'Stellt den Geldbetrag dar, den der Händler dem Kunden zurückerstattet. Es können nur gebuchte Beträge verrechnet werden.',
    'HELP_D3UNZER_SETTINGS_MGW_DEBUGMODE'                           => '<strong>Aktiv:</strong><br> Zeichnet jede Kommunikationsschritt über die Unzer PHP Api auf. <br>Die einzelnen Einträge werden im Logging hinterlegt.<br>Der Debug Modus kann auch im Live aktiviert werden.<br><br><strong>ACHTUNG! Dieser Haken verursacht eine hohe Datenlast auf die Tabelle d3log. Bitte nur nach Aufforderung nutzen!</strong>',
    ...
    'HELP_D3DYN_UNZER_WEBHOOK' => "Via webhooks, Unzer informs the connected system of changes in the status of the transactions, which can then be processed further. In this overview, all webhooks that have been set up (shop's own and external) are listed. Each time these settings are saved, all the shop's own webhooks are updated.",
];
