...
[{if $oView->hasOnlyBasicFunctions()}]
    ...
    <div class="extension_warning">[{oxmultilang ident="D3_UNZER_RESTRICTIONINFO"}]</div>
[{/if}]
[{if $blCurlMissing}]
...
<form name="myedit" id="myedit" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
            <td class="edittext">
                [{oxmultilang ident="D3UNZER_INTERFACE_TYPE"}]
            </td>
            <td class="edittext">
                [{oxinputhelp ident="HELP_D3UNZER_INTERFACE_TYPE"}]
                <select
                        name="value[d3_cfg_mod__heidelpayInterfaceType]"
                        title="[{oxmultilang ident="D3UNZER_INTERFACE_TYPE"}]">
                    <option value="ngw"
                            [{if ($heidelpayInterfaceType == "ngw")}]selected[{/if}]>
                        [{oxmultilang ident="D3UNZER_INTERFACE_TYPE_NGW"}]
                    </option>
                    <option value="mgw"
                            [{if ($heidelpayInterfaceType == "mgw")}]selected[{/if}]>
                        [{oxmultilang ident="D3UNZER_INTERFACE_TYPE_MGW"}]
                    </option>
                </select>
            </td>
        </tr>
        [{include file="@d3unzer/admin/settings/$heidelpayInterfaceType.tpl"}]
