        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr class="listitem">
                ...
                <td class="listheader" width="30" height="15" align="center">
                    <a href="Javascript:top.oxid.admin.setSorting(document.search, '', 'isTestConfig', '[{$nextSorting.isTestConfig}]');document.search.submit();" class="listheader" title="[{oxmultilang ident="D3UNZER_CONFIG_ISTESTCONFIG"}]">T</a>
                </td>
                <td class="listheader">
                ...
                <td class="listheader" colspan="2" height="15">
                    [{if $showChannel}]
                    <a href="Javascript:top.oxid.admin.setSorting(document.search, '', 'channel', '[{$nextSorting.channel}]');document.search.submit();" class="listheader">[{oxmultilang ident="D3UNZER_CONFIG_CHANNEL"}]</a>
                    [{/if}]
                </td>
            </tr>
            ...
            [{foreach from=$channels item="channel" key="identifier" name="channelList"}]
                ...
                <tr id="row.[{$smarty.foreach.channelList.iteration}]">
                    ...
                    <td class="[{$listclass}] [{if $channel->isTestConfig()}] active[{/if}]" valign="top" height="15" title="[{oxmultilang ident="D3UNZER_CONFIG_ISTESTCONFIG"}]">
                        <div class="listitemfloating">&nbsp;</div>
                    </td>
                    <td class="[{$listclass}]">
                    ...
                    <td class="[{$listclass}]" height="15">
                        <div class="listitemfloating">
                            <a href="Javascript:top.oxid.admin.editThis('[{$channelId}]');" class="[{$listclass}]">
                                [{oxmultilang ident="D3_UNZER_CHANNEL_"|cat:$channel->getPaymentTypeIdent()|upper}]
                            </a>
                        </div>
                    </td>
                    [{if $showChannel}]
                    ...
                    [{/if}]
                    <td class="[{$listclass}]"[{if false === $showChannel}] colspan="2"[{/if}]>
