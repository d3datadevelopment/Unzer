...
<div class="form-group">
    ...
    <div class="col-md-8">
        ...
        >
            <option value="PLEASE_CHOOSE"[{if $actualSelection === 'PLEASE_CHOOSE'}] selected[{/if}]>[{oxmultilang ident="D3UNZER_sD3HpHFOrderCancelType_PLEASE_CHOOSE"}]</option>
            <option value="CANCEL_ORDER"[{if $actualSelection === 'CANCEL_ORDER'}] selected[{/if}]>[{oxmultilang ident="D3UNZER_sD3HpHFOrderCancelType_CANCEL_ORDER"}]</option>
            <option value="DELETE_ORDER"[{if $actualSelection === 'DELETE_ORDER'}] selected[{/if}]>[{oxmultilang ident="D3UNZER_sD3HpHFOrderCancelType_DELETE_ORDER"}]</option>
        </select>
    </div>
</div>
