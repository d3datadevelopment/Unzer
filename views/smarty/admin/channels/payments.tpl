    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="legende">
                ...
                <div class="paytypestatus">[{oxmultilang ident="D3UNZER_CHANNELS_ASSIGNED"}]</div>
                <br>
                <div class="paytype inact">&nbsp;</div>
                <div class="paytypestatus">[{oxmultilang ident="D3UNZER_CHANNELS_NOTASSIGNED"}]</div>
                <br>
                <div class="paytype used">&nbsp;</div>
                <div class="paytypestatus">[{oxmultilang ident="D3UNZER_CONFIG_ALREADY_ASSIGNED_TO_OTHER_CONFIG"}]</div>
        ...
        <div class="col-xs-12">
            <form class="form-horizontal" action="[{$oViewConf->getSelfLink()}]" method="post">
                ...
                <table class="table table-condensed">
                    <tr>
                        <th>[{oxmultilang ident="D3UNZER_CONFIG_SHOPPAYMENT"}]</th>
                        <th>[{oxmultilang ident="D3UNZER_CONFIG_CHANNELCONFIGURATION"}]</th>
                        <th class="headcenter">[{oxmultilang ident="D3UNZER_CONFIG_ISASSIGNED"}]</th>
                    </tr>
                ...
                <div class="form-group">
                    <div class="alert alert-info" style="padding:5px;text-align:right;width:100%;">
                        <button class="btn btn-primary" type="submit">
                            [{oxmultilang ident="D3UNZER_CHANNELS_SAVE"}]
                        </button>
                    </div>
                </div>
            </form>
