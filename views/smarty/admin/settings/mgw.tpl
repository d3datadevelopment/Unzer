<tr>
    <td class="edittext">
        [{oxmultilang ident="D3UNZER_SETTINGS_MGW_DEBUGMODE"}]
    </td>
    <td class="edittext">
        [{oxinputhelp ident="HELP_D3UNZER_SETTINGS_MGW_DEBUGMODE"}]
        ...
        <input id="module_debug"
               ...
               name="logtypes[7]"
               value="1"
               title="[{oxmultilang ident="D3UNZER_SETTINGS_MGW_DEBUGMODE"}]"
...
<tr>
    ...
    <td class="edittext">
        ...
        [{include file="@d3modcfg_lib/admin/inc/loglevel_form.tpl" oLogSet=$oLogSet oModule=false}]
    </td>
</tr>
<tr>
    <td colspan="2">
        <fieldset title="[{oxmultilang ident="D3DYN_HEIDELPAY_LOGIN_LIVE_HEADER"}]">
            <legend>
                <b>[{oxmultilang ident="D3UNZER_LOGIN_MGW_HEADER"}]</b>[{oxinputhelp ident="HELP_D3UNZER_LOGIN_MGW_HEADER"}]
            </legend>
            <table style="width: 50%">
                <tr>
                    <td class="edittext">
                        [{oxmultilang ident="D3UNZER_SETTINGS_MGW_PRIVATE"}]
                    </td>
                    <td class="edittext">
                        <input type="text"
                               class="editinput"
                               ...
                               title="[{oxmultilang ident="D3UNZER_SETTINGS_MGW_PRIVATE"}]"
                               style="width: 100%"
                        >
                    </td>
                </tr>
                <tr>
                    <td class="edittext">
                        [{oxmultilang ident="D3UNZER_SETTINGS_MGW_PUBLIC"}]
                    </td>
                    <td class="edittext">
                        <input type="text"
                               class="editinput"
                               ...
                               title="[{oxmultilang ident="D3UNZER_SETTINGS_MGW_PUBLIC"}]"
                               style="width: 100%"
                        >
                    </td>
                </tr>
...
<tr>
    <td colspan="2">
        <fieldset>
            <legend><strong>[{oxmultilang ident="D3UNZER_WEBHOOKS_HEADLINE"}]</strong>[{oxinputhelp ident="HELP_D3DYN_UNZER_WEBHOOK"}]</legend>
            [{if !empty($registeredWebhooks)}]
                <table style="padding: 0; width: 100%; border-spacing: unset; border: 0">
                    <tr>
                        <th>[{oxmultilang ident="D3UNZER_WEBHOOKS_HEADLINE_URL"}]</th>
                        <th>[{oxmultilang ident="D3UNZER_WEBHOOKS_HEADLINE_EVENTS"}]</th>
                        <th>[{oxmultilang ident="D3UNZER_WEBHOOKS_HEADLINE_ID"}]</th>
                    </tr>
            ...
            [{else}]
                <span style="display: inline-block; color: darkred; font-weight: bold; width: 100%; text-align: center">[{oxmultilang ident="D3UNZER_WEBHOOKS_NOWEBHOOKREGISTERED"}]</span>
            [{/if}]
        </fieldset>
    </td>
</tr>
