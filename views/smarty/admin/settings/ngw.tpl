                ...
                <dl>
                    <dd>
                        <table cellspacing="5" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                                <td class="edittext">
                                    [{oxmultilang ident="D3UNZER_DIFFERENCE_IN_ORDER_ERRRORMAIL"}]
                                </td>
                                <td class="edittext">
                                    [{oxinputhelp ident="HELP_D3UNZER_DIFFERENCE_IN_ORDER_ERRRORMAIL"}]
                                    ...
                                    <input type="text"
                                           ...
                                           title="[{oxmultilang ident="D3UNZER_DIFFERENCE_IN_ORDER_ERRRORMAIL"}]"
                                           value="[{$statusemail}]">
                                </td>
                            </tr>
                            <tr>
                                <td class="edittext">
                                    [{oxmultilang ident="D3UNZER_DIFFERENCE_IN_ORDER_ERRRORSTATUS"}]
                                </td>
                                <td class="edittext">
                                    [{oxinputhelp ident="HELP_D3UNZER_DIFFERENCE_IN_ORDER_ERRRORSTATUS"}]
                                    ...
                                    <input type="text"
                                           ...
                                           title="[{oxmultilang ident="D3UNZER_DIFFERENCE_IN_ORDER_ERRRORSTATUS"}]"
                                           value="[{$transstatuserror}]">
                                </td>
                            </tr>
                            <tr>
                                <td class="edittext">
                                    [{oxmultilang ident="D3UNZER_CARDTYPE_TIMEOUT"}]
                                </td>
                                <td class="edittext">
                                    ...
                                    <input type="number"
                                           ...
                                           title="[{oxmultilang ident="D3UNZER_CARDTYPE_TIMEOUT"}]"
...
<tr>
    <td colspan="2">
        <div class="groupExp">
            <div>
                <a href="#" onclick="_groupExp(this);return false;"
                   class="rc"><b>[{oxmultilang ident="D3UNZER_SETTINGS_NOTIFY_LABEL"}]</b></a>
                <dl>
                    <dd>
                        <p class="warning wrap">[{oxmultilang ident="D3UNZER_SETTINGS_NOTIFYURL_INFO"}]</p>
                        <hr>
                        <label>
                            [{oxmultilang ident="D3UNZER_SETTINGS_NOTIFYURL"}]
                            [{oxinputhelp ident="HELP_D3UNZER_SETTINGS_NOTIFYURL"}]
                            <br>
...
<tr>
    <td colspan="2">
        <div class="groupExp">
            <div>
                <a href="#" onclick="_groupExp(this);return false;"
                   class="rc"><b>[{oxmultilang ident="D3UNZER_SETTINGS_FOR_IDEAL_AND_P24_CRONJOB"}]</b></a>
                <dl>
                    <dt>
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td class="edittext">
                                    [{oxmultilang ident="D3UNZER_sD3HpHFOrderPendingTime"}]
                                </td>
                                <td class="edittext">
                                    ...
                                    <input size="5"
                                           ...
                                           title="[{oxmultilang ident="D3UNZER_sD3HpHFOrderPendingTime"}]"
                                           type="text">
                                </td>
                            </tr>
                            <tr>
                                <td class="edittext">
                                    [{oxmultilang ident="D3UNZER_sD3HpHFOrderLimit"}]
                                </td>
                                <td class="edittext">
                                    ...
                                    <input size="5" name="value[d3_cfg_mod__sD3HpHFOrderLimit]"
                                           ...
                                           title="[{oxmultilang ident="D3UNZER_sD3HpHFOrderLimit"}]"
                                           type="text">
                                </td>
                            </tr>
                            <tr>
                                <td class="edittext">
                                    [{oxmultilang ident="D3UNZER_sD3HpHFOrderCancelType"}]
                                </td>
                                <td class="edittext">
                                    ...
                                    <select name="value[d3_cfg_mod__sD3HpHFOrderCancelType]"
                                            title="[{oxmultilang ident="D3UNZER_sD3HpHFOrderCancelType"}]">
                                        <option value="PLEASE_CHOOSE"[{if $currentCancelType == ''}] selected[{/if}]>[{oxmultilang ident="D3UNZER_sD3HpHFOrderCancelType_PLEASE_CHOOSE"}]</option>
                                        <option value="CANCEL_ORDER"[{if $currentCancelType === 'CANCEL_ORDER'}] selected[{/if}]>[{oxmultilang ident="D3UNZER_sD3HpHFOrderCancelType_CANCEL_ORDER"}]</option>
                                        <option value="DELETE_ORDER"[{if $currentCancelType === 'DELETE_ORDER'}] selected[{/if}]>[{oxmultilang ident="D3UNZER_sD3HpHFOrderCancelType_DELETE_ORDER"}]</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td class="edittext">
                                    [{oxmultilang ident="D3UNZER_blD3HpHFSetZeroOrderNumber"}]
                                </td>
                                <td class="edittext">
                                    ...
                                    <input name="value[d3_cfg_mod__blD3HpHFSetZeroOrderNumber]"
                                           ...
                                           title="[{oxmultilang ident="D3UNZER_blD3HpHFSetZeroOrderNumber"}]">
