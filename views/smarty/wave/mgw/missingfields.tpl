    ...
    <div class="d3UnzerMissingFields">
        [{foreach from=$d3UnzerMissingUserParameter[$oxidPaymentId] item="unzerFieldname" key="oxidFieldname"}]
            ...
            <div class="form-group">
                <label class="control-label col-lg-3 req" for="[{$sPaymentID}]_[{$oxidFieldname}]">[{oxmultilang ident="D3UNZER_PAYMENT_MGW_MISSINGFIELD_INPUT_"|cat:$oxidFieldname}]</label>
                <div class="col-lg-5">
