<div class="alert alert-info">
    ...
    <p>
        ...
        [{oxmultilang ident="D3UNZER_THANKYOU_PREPAYMENT_AMOUNT"}] [{$oPrePaymentData.formattedAmount}] [{$oPrePaymentData.currency}]
        <br/>
        [{if $oPrePaymentData.descriptor}]
            [{oxmultilang ident="D3UNZER_THANKYOU_PREPAYMENT_REASON"}] [{$oPrePaymentData.descriptor}]
        [{/if}]
