            ...
            <dt>
                ...
                [{if false == $blD3HeidelpayAllowEasyCredit}]
                    <dfn id="d3HeidelayEasycreditNotice"
                         class="alert alert-danger desc">[{oxmultilang ident="D3UNZER_PAYMENT_EASYCREDIT_NOTICE" args=$iD3HeidelpayEasycreditLimits}]</dfn>
                [{/if}]
                        ...
                        <div class="col-xs-12 col-lg-9 offset-lg-3">
                            [{if $blD3HeidelpayEasycreditNotChecked}]
                                <div class="alert alert-danger desc">
                                    [{oxmultilang ident="D3UNZER_PAYMENT_EASYCREDIT_CHECKBOX_NOT_CHECKED"}]
                                </div>
                            [{/if}]
