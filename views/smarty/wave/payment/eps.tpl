            ...
            <dt>
                ...
                [{if false == $blD3HeidelpayAllowEPS}]
                    <dfn id="d3HeidelayEpsNotice"
                         class="alert alert-danger">[{oxmultilang ident="D3UNZER_PAYMENT_EPS_NOTICE"}]</dfn>
                [{/if}]
            </dt>
            <dd class="payment-option [{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
                <div class="form-group">
                    <label class="req col-lg-3" for="d3heidelpay_eps_[{$paymentmethod->oxpayments__oxid->value}]">
                        [{oxmultilang ident="D3UNZER_PAYMENT_INPUT_BANK_ACCOUNTHOLDER"}]
                    </label>
                    <div class="col-lg-9">
                        <input type="text"
                               ...
                               title="[{oxmultilang ident="D3UNZER_PAYMENT_INPUT_BANK_ACCOUNTHOLDER"}]"
                ...
                [{if $blD3HeidelpayAllowEPS}]
                    <div class="form-group">
                        <label class="req col-lg-3"
                               for="payment_[{$sPaymentID}]_1">[{oxmultilang ident="D3UNZER_PAYMENT_INPUT_BANK"}]</label>
