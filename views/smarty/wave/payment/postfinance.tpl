        ...
        <dl>
            <dt>
                ...
                <label for="payment_[{$sPaymentID}]">
                    ...
                    [{include file="@d3unzer/generic/payment_img.tpl" sImageUrl=$sImageUrl|cat:'logo_postfinance.png' sBrandIdent=$sBrandIdent}]
                </label>
                [{if false == $blD3HeidelpayAllowPostFinance}]
                    <dfn id="d3HeidelayPostfinanceNotice" class="alert alert-danger">[{oxmultilang ident="D3UNZER_PAYMENT_POSTFINANCE_NOTICE"}]</dfn>
                [{/if}]
            </dt>
                ...
                [{if $blD3HeidelpayAllowPostFinance}]
                    <div class="form-group">
                        <label class="col-sm-4"
                               for="payment_[{$sPaymentID}]_1">[{oxmultilang ident="D3UNZER_PAYMENT_POSTFINANCE_PAYMENTS"}]</label>
                        <div class="col-sm-4">
