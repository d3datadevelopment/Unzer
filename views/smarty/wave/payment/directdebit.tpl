            ...
            <dt>
                ...
                <label for="payment_[{$sPaymentID}]">
                    ...
                    [{if $sPaymentID != 'oxiddebitnote'}]
                        [{include file="@d3unzer/generic/payment_img.tpl" sImageUrl=$sFullImageUrl sBrandIdent=$paymentmethod->oxpayments__oxdesc->value}]
                    [{/if}]
                </label>
                [{if false == $blShowPaymentMethod}]
                    <dfn class="alert alert-danger d3HeidelaySameAddressNotice">[{oxmultilang ident="D3UNZER_PAYMENT_NOTSAMEADDRESS_NOTICE"}]</dfn>
                [{/if}]
            </dt>
            <dd class="payment-option [{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
                ...
                <div class="form-group">
                    <label class="req col-lg-3"
                           for="sCountrySelected_[{$sPaymentID}]">[{oxmultilang ident="D3UNZER_CC_INPUT_COUNTRY"}]</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group" id="sBIC_[{$sPaymentID}]">
                    <label class="req col-lg-3"
                           for="sCountrySelected_[{$sPaymentID}]lsblz">[{oxmultilang ident="D3UNZER_PAYMENT_INPUT_BANK_BIC"}]</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group">
                    <label class="req col-lg-3"
                           for="sCountrySelected_[{$sPaymentID}]lsktonr">[{oxmultilang ident="D3UNZER_PAYMENT_INPUT_BANK_IBAN"}]</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group">
                    <label class="req col-lg-3"
                           for="sCountrySelected_[{$sPaymentID}]lsktoinhaber">[{oxmultilang ident="D3UNZER_PAYMENT_INPUT_BANK_ACCOUNTHOLDER"}]</label>
                    <div class="col-lg-9">
