        ...
        <dl>
            <dt>
                ...
                <label for="payment_[{$sPaymentID}]">
                    ...
                    [{include file="@d3unzer/generic/payment_img.tpl" sImageUrl=$sFullImageUrl sBrandIdent=$sBrandIdentIdeal}]
                </label>
                [{if false == $blD3HeidelpayAllowIdeal}]
                    <dfn id="d3HeidelayPrzelewy24Notice"
                         class="alert alert-danger">[{oxmultilang ident="D3UNZER_PAYMENT_IDEAL_NOTICE"}]</dfn>
                [{/if}]
            </dt>
